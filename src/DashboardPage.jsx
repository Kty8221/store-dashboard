            ...
            <ul className="item-list">
              {inventoryList.map((item)=> (
                <li key={item.name}>
                  ...
                  <span className={`badge ${getInventoryStatus(item.stock, item.target)}`}>
              ...
              {forecastList.map((item) => (
                <li key={item.day}>
                  <div>
                    ...
                    {item.event && <p className="event-tag">이벤트: {item.event}</p>}
                  </div>
                </li>
              ))}
            </ul>
